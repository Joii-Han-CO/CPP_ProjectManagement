...
class AddProject:
  ...
  def __GetSlnInfo(self):
    info_path = self.__sln_path + '\\project\\project_info.txt'
  ...
  def __CheckPath(self):
    ...
    if utility.CheckPath(self.__sln_path + '\\project\\' + self.__prj_folder + '\\' + self.__prj_name) == False:
      self.__last_error = '检测工程路径错误--' + utility.GetLastError()
      return False
  ...
  def AddCMake(self):
    cmake_path = self.__sln_path + '\\project\\CMakeLists.txt'
